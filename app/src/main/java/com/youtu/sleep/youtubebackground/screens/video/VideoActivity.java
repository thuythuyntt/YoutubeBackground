...
public class VideoActivity extends BaseActivity implements VideoContract.View,
    ...
    public List<Video> getListVideo() {
        ...
        list.add(new Video("EVnzXA9b7Ww", "Cat and Dog", "Dog", "", ""));
        list.add(new Video("j8cJONHXEMI", "Cat lover", "Cat", "Cat", ""));
        list.add(new Video("4jw7qqWLs4M", "Dog lover", "Dog", "", ""));
        list.add(new Video("lvi-LVKCthQ", "Cat Rick", "Cat&Dog", "", ""));
        return list;
